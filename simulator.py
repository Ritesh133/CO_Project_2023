...
address = "0000000"
ser_no = 0
register_dict = {"000":["RO","0000000000000000"],"001":["R1","0000000000000000"],"010":["R2","0000000000000000"],"011":["R3","0000000000000000"],"100":["R4","0000000000000000"],"101":["R5","0000000000000000"],"110":["R6","0000000000000000"],"111":["FLAGS","0000000000000000"]}
...
def execution_instruction(curr_inst):
    ...
    if(curr_inst[:5]=="00111"):
        ...
        if(den==0):
            ...
            quotient = num/den
            rem = num%den
            bin_quo = make_binary(int(quotient))
            bin_rem = make_binary(int(rem))
...
while(PC<number_of_inst):
    ...
    # for type A
    if(curr_inst[:5]=="00000" or curr_inst[:5]=="00110" or curr_inst[:5]=="01010" or curr_inst[:5]=="01011" or curr_inst[:5]=="01100"):
    ...
    if(curr_inst[:5]=="01110"):
       aa = execution_instruction(curr_inst)
    print(f'{address_of_instruction[PC]} {register_dict["000"][1]} {register_dict["001"][1]} {register_dict["010"][1]} {register_dict["011"][1]} {register_dict["100"][1]} {register_dict["101"][1]} {register_dict["110"][1]} {register_dict["111"][1]}')
#updation of pc
